...
if __name__=='__main__':
    ...
    train_data_x=np.array(train_data[:,1:])
    train_data_y=np.array(train_data[:,0])
    
    
    test_data_x=np.array(loadCsv(test_path))

    
    data,test_data,w11,w12,b11,b12=layer1(train_data_x,test_data_x,28*28,200,400)
